...
return [
    ...
    'need_amount_to_forward' => 'You must enter a car cost (or total amount) to mark inspection complete.',
    'saved_ok' => 'Saved.',
    'inspected_ok' => 'Marked inspection complete. Sales will forward it to the buyer on the "Awaiting forward" screen.',
    'complete_section' => 'Inspection complete',
    'complete_button' => 'Mark inspected (to awaiting forward)',
    'complete_button_selected' => '— Selected ✓',
    'complete_hint' => 'After entering photos and amounts, select complete and save. Sales forwards to the buyer on the "Awaiting forward" screen.',
    'already_inspected' => 'Inspected. It is on the sales "Awaiting forward" list. (Amounts/photos still editable)',
    'already_forwarded_simple' => 'Already forwarded to buyer (awaiting reply onward). Handled on the sales screens.',
