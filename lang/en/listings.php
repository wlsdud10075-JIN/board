...
return [
    ...
    'add_form' => [
        ...
        'method_self' => 'Self-inspected purchase — skips on-site check, forwarding and buyer reply; goes straight to Auction/Purchase on save.',
        ...
        'saved_self_flash' => 'Self-inspected purchase :number registered — skipped on-site check and buyer reply, moved to Auction/Purchase.',
    ...
    // Encar vehicle history (insurance / inspection / diagnosis) — read-only, not stored
    'history' => [
        'view' => 'History',
        'title' => 'Encar vehicle history (read-only)',
        'need_link' => 'Enter and extract an Encar link first.',
        'none' => 'No history available.',
        'no_data' => 'No data',
        'record' => 'Insurance history',
        'my_accident' => 'Own-vehicle accidents',
        'other_accident' => 'Other-party accidents',
        'owner_change' => 'Owner changes',
        'total_loss' => 'Total loss',
        'flood' => 'Flood',
        'robber' => 'Theft',
        'special_use' => 'Gov/Commercial',
        'acc_date' => 'Date',
        'acc_benefit' => 'Payout',
        'acc_part' => 'Parts',
        'acc_labor' => 'Labor',
        ...
        'waterlog' => 'Water damage',
        'recall' => 'Recall',
        'inspector' => 'Inspector',
        'inners' => 'Self-diagnosis',
        'outers' => 'Body panels',
        'diagnosis' => 'Encar diagnosis',
        'yes' => 'Yes',
        'no' => 'No',
    ],
    ...
    'attach_view' => [
        ...
        'hint' => 'Photos/documents added at purchase confirmation (delete on the auction/purchase screen)',
    ...
    'drawer' => [
        ...
        'delete_confirm' => 'Delete this purchase record? It disappears from the list and the same vehicle number can be registered again. (Logged to audit)',
