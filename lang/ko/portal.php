...
return [
    ...
    'req_pick_required' => '차량을 하나 이상 선택하세요.',
    'req_send_failed' => '전송 실패 (HTTP :status) — 보내지지 않았습니다.',
    'req_result_created' => '전송됨',
    'req_result_skipped' => '건너뜀',
    'req_reason_already_open' => '이미 요청됨',
    'req_reason_forbidden' => '본인 차량 아님',
    'req_dismiss' => '닫기',
    'req_chip_open' => '요청중',
    'req_chip_done' => '확인됨',
    ...
    'plan_intro' => '판매된 수출 차량을 <b>묶음으로 구성</b>해 한 번에 동기화합니다. 묶음 = 1선적 = 1 B/L.<br><b>대금이 덜 들어온 차도 미리 묶어둘 수 있습니다</b> — 서류를 미리 준비하는 용도이고, 실제 선적 진행은 입금 후에 시작됩니다.',
    ...
    'plan_unpaid' => '미수',
    'plan_fx_missing' => '환율 미입력',
    'plan_fx_missing_hint' => '환율이 없어 완납 여부를 판정할 수 없습니다 — 완납이라는 뜻이 아닙니다.',
