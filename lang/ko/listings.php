...
return [
    ...
    'list' => [
        ...
        'per_page' => ':count개씩',
        'count_only' => '건수만',
        'count_only_hint' => '지금 탭에 :count건 있습니다. (목록을 보려면 개수를 고르세요)',
    ],
    ...
    'add_form' => [
        ...
        'method_self' => '셀프검차매입 — 현지확인·전달·회신을 건너뛰고 저장 즉시 경매/구매 탭으로 넘어갑니다.',
        'vehicle_number' => '차량번호',
        ...
        'saved_self_flash' => '셀프검차매입 :number 등록 — 현지확인·회신을 건너뛰고 경매/구매로 넘어왔습니다.',
    ...
    // 엔카 차량이력 (보험/성능점검/진단) — 조회전용, 저장 안 함
    'history' => [
        'view' => '이력 조회',
        'title' => '엔카 차량이력 (조회전용)',
        'need_link' => '엔카 링크를 먼저 입력·추출하세요.',
        'none' => '이력 정보가 없습니다.',
        'no_data' => '정보 없음',
        'record' => '보험이력',
        'my_accident' => '내차 사고',
        'other_accident' => '타차 사고',
        'owner_change' => '소유자 변경',
        'total_loss' => '전손',
        'flood' => '침수',
        'robber' => '도난',
    ...
    // 차량 첨부
    // 목록 탭 (2026-09-11) — 상태를 묶어 한 덩어리씩 읽는다. 기본 = 진행중.
    'tabs' => [
        'all' => '전체',
        'active' => '진행중',
        'draft' => '현지확인 대기',
    ...
    // 편집 드로어
    'resync' => [
        'title' => '판매 금액 보완 · ERP 재전송',
        'hint' => '급하게 매입가만 보낸 차의 판매가를 나중에 채웁니다 (ERP 의 빈 칸만 채워집니다)',
        'sale_price' => '판매가',
        'currency' => '통화',
        'rate' => '환율',
        'btn' => 'ERP 로 다시 보내기',
        'not_synced_yet' => '아직 ERP 로 전송되지 않은 차량입니다. 구매확정 후에 사용할 수 있습니다.',
        'currency_required' => '통화를 선택하세요 — 통화가 없으면 ERP 가 판매가를 넣지 않습니다.',
        ...
        'queued' => 'ERP 로 전송 요청했습니다 — 결과가 오면 여기에 표시됩니다 (몇 초).',
        // ERP 가 돌려주는 키를 사람 말로. 🚫 목록에 없으면 원문을 그대로 보여준다(사유를 버리면 추적 불가).
        'field' => [
            'sale_price' => '판매가',
            'sale_currency' => '통화',
            'sale_exchange_rate' => '환율',
            'sale_date' => '판매일',
            'transport_fee' => '운임비',
            'buyer_id' => '바이어',
            'consignee_id' => '컨사이니',
        ...
        'why' => [
            'already_set' => 'ERP 에 이미 값이 있어 그대로 둠',
            'missing_exchange_rate' => '환율이 없어 보류됨',
            'invalid_or_inactive' => 'ERP 에 없거나 사용중지된 대상',
            'buyer_mismatch' => '그 바이어 소속이 아님',
            'buyer_not_sent' => '바이어를 함께 보내지 않음',
        ],
    ...
    'attach_view' => [
        'title' => '딜러 차량 첨부',
        'hint' => '구매확정 때 올린 사진·서류 (추가는 아래에서 · 삭제는 「경매/구매」 화면에서)',
        'empty' => '아직 올린 사진·서류가 없습니다.',
    ],

    // ERP 로 넘어간 차에 사진·서류를 나중에 추가(2026-09-11) — 금액은 같이 안 보낸다.
    'attach_add' => [
        'section' => '＋ 사진·서류 추가하기',
        'dropzone' => '여기를 눌러 파일 고르기',
        'dropzone_sub' => '고른 뒤 아래 [추가하고 ERP 로 보내기]를 누르면 ERP 에도 함께 등록됩니다',
        'btn' => '추가하고 ERP 로 보내기',
        'sending' => '보내는 중…',
        'help' => '💡 딜러가 늦게 준 사진도 여기서 올리면 ERP 차량 첨부에 함께 등록됩니다 (최대 :max건 · 같은 파일은 두 번 안 들어감 · 금액은 바뀌지 않습니다). 여기서 지워도 ERP 에서는 안 지워지기 때문에 삭제는 막아뒀습니다.',
        'not_synced_yet' => '아직 ERP 로 보내지 않은 차량입니다 — 사진은 「경매/구매」 화면에서 올려 주세요.',
        'none_selected' => '추가할 파일을 먼저 선택하세요.',
        'queued' => ':count건 전송 요청했습니다 — ERP 반영 결과가 오면 여기에 표시됩니다 (몇 초).',
        'sent' => ':count건 전송했습니다.',
        'ok' => 'ERP 차량 첨부에 :added건 붙었습니다.',
        'partial' => ':sent건 중 :added건만 ERP 에 붙었습니다 — ERP 차량의 첨부 한도(10장)에 걸렸거나 이미 같은 파일이 있을 수 있습니다. ERP 차량 화면에서 확인하세요.',
        'failed' => 'ERP 가 :count건을 복사하지 못했습니다 — 관리자에게 알려 주세요.',
    ],
