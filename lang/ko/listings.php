...
return [
    ...
    'list' => [
        ...
        'per_page' => ':count개씩',
        'count_only' => '건수만',
        'count_only_hint' => '이 조건에 :count건 있습니다. (목록을 보려면 개수를 고르세요)',
    ],
    ...
    'attach_view' => [
        'title' => '딜러 차량 첨부',
        'hint' => '구매확정 때 올린 사진·서류 (삭제는 경매/구매 화면에서)',
    ...
    'attach_add' => [
        ...
        'btn' => '추가하고 ERP 로 보내기',
        'sending' => '보내는 중…',
        'help' => '💡 딜러가 늦게 준 사진도 여기서 올리면 ERP 차량 첨부에 붙습니다 (최대 :max건 · 같은 파일은 중복으로 안 들어감 · 금액은 변경되지 않음). 삭제는 ERP 로 전파되지 않아 막아뒀습니다.',
        'not_synced_yet' => '아직 ERP 로 전송되지 않은 차량입니다 — 사진은 경매/구매 화면에서 올려 주세요.',
