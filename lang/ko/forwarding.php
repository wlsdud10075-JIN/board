...
return [
    ...
    // 금액 수정 (재견적·조정) — 저장 시 최종금액·견적 재계산
    'amount_section' => '금액 (수정 후 저장 → 재계산)',
    'amount_save' => '금액 저장 · 견적 갱신',
    'amount_saved' => '금액이 수정되어 최종금액·견적이 갱신되었습니다.',
    'amount_hint' => '바이어가 할인을 요청하면 차값/할인율/배송을 고치고 저장하세요. 최종금액과 견적 카드가 다시 계산됩니다.',
