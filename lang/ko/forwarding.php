...
return [
    ...
    'amount_section' => '금액 (수정 시 자동 반영)',
    'amount_hint' => '바이어가 할인을 요청하면 차값/할인율/배송을 고치세요. 입력칸을 벗어나면 자동 저장되어 최종금액·견적 카드가 다시 계산됩니다. (외화 딜은 위 통화 버튼을 다시 눌러 환산을 새로 굳히세요.)',
    ...
    // 영상 — 파일이 커서 공유시트로 못 보내므로 presigned 링크로 따로 전송
    'video_section' => '영상 (링크로 전송)',
    'video_send' => '보내기',
    'video_hint' => '영상은 파일이 커서 사진처럼 한 번에 못 보냅니다. 버튼을 누르면 영상 링크가 공유시트/클립보드로 — 카톡 등에 붙여넣어 보내세요. (링크 60분 유효)',
