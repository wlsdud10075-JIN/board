...
return [
    ...
    'alimtalk_sending' => '발송 중…',
    'alimtalk_send_hint' => '배정된 검차원에게 지역별 검차 대상 차량 목록을 알림톡으로 보냅니다. (이미 보낸 차량은 중복 발송 안 됨)',
    ...
    'photo_share_hint' => '검차 사진/영상은 기본으로 바이어에게 공개됩니다. 번호판 근접·민감 사진은 "바이어공개"를 꺼서 빼세요. (서류는 자동 제외)',
