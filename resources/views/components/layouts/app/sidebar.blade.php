    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-r border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <a href="{{ route('dashboard') }}" class="mr-5 flex items-center gap-2 px-1" wire:navigate>
                <span class="flex size-8 items-center justify-center rounded-lg bg-[var(--color-primary)] font-extrabold text-white">B</span>
                <span class="text-sm font-bold">매입·검차·경매</span>
            </a>
